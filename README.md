...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/os-client-config-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/os-client-config-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/os-client-config-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/os-client-config-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/os-client-config-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/os-client-config-feedstock/branch/master)
