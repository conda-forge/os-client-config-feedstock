...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/os-client-config-feedstock.svg?style=svg)](https://circleci.com/gh/conda-forge/os-client-config-feedstock)
...
If you would like to improve the os-client-config recipe, please take the normal
